...
class Conv_ReLU_Block(nn.Module):
    def __init__(self):
        ...
        self.bn1 = nn.BatchNorm2d(64)
        self.conv2 = nn.Conv2d(in_channels=64, out_channels=64, kernel_size=1, stride=1, padding=0, bias=False)
...
# code taken from https://github.com/twtygqyy/pytorch-vdsr/blob/master/vdsr.py   
